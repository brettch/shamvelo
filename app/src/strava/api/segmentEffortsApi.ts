...
import { DetailedSegmentEffort } from '../model/detailedSegmentEffort.js';
...
export class SegmentEffortsApi {
     ...
     */
    public async getEffortsBySegmentId (segmentId: number, startDateLocal?: Date, endDateLocal?: Date, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<DetailedSegmentEffort>;  }> {
        ...
        if (segmentId !== undefined) {
            localVarQueryParameters['segment_id'] = ObjectSerializer.serialize(segmentId, "number");
        }

        if (startDateLocal !== undefined) {
            localVarQueryParameters['start_date_local'] = ObjectSerializer.serialize(startDateLocal, "Date");
        }

        if (endDateLocal !== undefined) {
            localVarQueryParameters['end_date_local'] = ObjectSerializer.serialize(endDateLocal, "Date");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Array<DetailedSegmentEffort>;  }>((resolve, reject) => {
     ...
     */
    public async getSegmentEffortById (id: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DetailedSegmentEffort;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DetailedSegmentEffort;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
